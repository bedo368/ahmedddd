...
from tasks import create_router_task , create_grader_task ,creare_retriever_task , creat_hallucination_task, create_answer_task

def main():
    print("...Starting the application...")
    # Download the PDF 
    pdf_filename = 'data/attenton_is_all_you_need.pdf'
    ...
    retriever_task = creare_retriever_task(retriever_agent, router_task , rag_tool, web_search_tool)
    grader_task = create_grader_task(grader_agent,retriever_task)
    hallucination_task = creat_hallucination_task(hallucination_grader,grader_task)
